...
\item[Clear] Put in an specific bit to the value of $0$. Also known as \emph{unset}.
...
For example, to set the bit at psition 2 of a variable, we make a biwise $OR$ between the corresponding mask and the variable.
...
Indeed, the most common (and compact) way to perform bit manipulation opearates in place.
Using the same vairiable as operand and output; and does not use a temporal storage for the mask.
