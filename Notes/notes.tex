...
\fancyhead[C]{Jorge Antonio García Galicia} %There is no utf8 in fancyhdr
...
\usepackage[newfloat=true]{minted} %For inserting source code and embed source files
...
\setminted[cpp]{tabsize=2,frame=lines,framesep=0.25cm,baselinestretch=1,fontsize=\scriptsize,breaklines}
...
\author{Jorge Antonio García Galicia} % Again, no utf8 I do not know why
\title{Study Notes}
\date{\today}
