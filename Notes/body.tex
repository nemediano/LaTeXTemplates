...
Provided that we acces it in the \emph{correct way}, the access tends to be faster than the alternative shown in Listing~\ref{lst:2dexample}
...
For memory flatening, we will need new functions $g$ and $h$, that depends in a new extra parameter: \mintinline{cpp}{DEPTH}.
