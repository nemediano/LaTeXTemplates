...
%I am a Ph.D. candidate with a strong background in mathematics and currently focused in computer science. I found out about the Principal Software Engineer position for Rendering in A360 from linkedin. I believe I am an excellent candidate for this job: first, because my graduate studies have been in Computer Graphics, since the masters and second, my professional expertise is also in software development on Graphics, moreover my last internship (Summer 2016) was in creating a rendering engine. Since I expect to graduate in August 2017, I am looking to start a career in software development, focused in Computer Graphics and Autodesk is the perfect place to do so.
...
%I have background in Computer Science and  Applied mathematics, because of that I am a proficient programmer and algorithmic thinker especially in C/C++ and because of computer graphics I also have experience using OpenGL and Qt for user applications. During my Ph.D. part of my research involved also paralyzingly computation on GPU using CUDA and compute sharers. And during my last internship, summer 2016, I worked in a deferred rendering engine for a research group and since then, I have been working in improvement in my OpenGL skills. In previous years I also did two internship at the most important GPU manufacture company in the world, there I learn about control version and automatic testing, so I am more than ready to work in a production environment.
...
%During my doctoral studies, I become familiar with several Autodesk products. I wrote a research article in 3D printing were I compare my algorithm for creating support structures to the one used in Meshmixer. I also have experience using Maya to model and render 3D meshes, for both my research work and my teaching. Finally, even when my professional background is technical, I come from a family of artists, I have experience doing live coding and I even coauthored an art paper at SIGRAPH so I am very positive about working in a company were artist and scientist work in close collaboration.
