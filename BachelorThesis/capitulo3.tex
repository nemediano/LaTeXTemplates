...
\begin{listing}
\inputminted[
  firstline=371, %If you omit this two fields, the whole file is pulled
  lastline=390
  ]{cpp}{../../../GLSamples/SoftBody/physics/SoftBody.cpp}
