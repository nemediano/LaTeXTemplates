...
El método \mintinline{cpp}{lst:calculateVolume} de la clase cara, suma la contribución de una cara al volumen usando la misma función \mintinline{cpp}{tethVolume} dos veces en los puntos que forman la cara (Listado~\ref{lst:get_contributed_volume})
{\centering
\begin{minipage}{\linewidth}
  \begin{listing}[H]
  \inputminted[
