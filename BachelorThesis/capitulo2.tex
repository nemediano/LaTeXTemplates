...
Lo parámetros necesarios son $m$ para cada partícula, $g$, $k_d$ y $k_s$ para los resortes, $L$ para cada resorte en particular, y $k_g$ para la acumulación de la fuerza debida a la presión.
...
El signo del volumen (por eso dijimos que es un volumen orientado) depende de si el tetraedo apunta hacia el origen.
