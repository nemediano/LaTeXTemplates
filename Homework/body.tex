...
\begin{figure}[htp]
  ...
  \caption{Plots for an imaginary exercise, lets call it $X$.}
  \label{fig:two}
\end{figure}
...
\item Lets look at how to write an algorith using pseudo code. See the algorithm~\ref{alg:euclid}. The information comes from this part of the \href{https://en.wikibooks.org/wiki/LaTeX/Algorithms#Typesetting_using_the_algorithmicx_package}{wikibook} and from this \href{https://tex.stackexchange.com/questions/229355/algorithm-algorithmic-algorithmicx-algorithm2e-algpseudocode-confused}{post}.
